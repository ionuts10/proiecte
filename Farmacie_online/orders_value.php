		...
		<table>
			...
			<tbody>
				<?php 
					...
					$query = "SELECT comanda_id, SUM(DC.cantitate * P.pret) AS valoare FROM detalii_comanda DC INNER JOIN tabela_produse P ON DC.produs_id = P.produs_id GROUP BY comanda_id ORDER BY valoare DESC";
